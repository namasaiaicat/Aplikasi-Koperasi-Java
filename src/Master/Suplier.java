...
private DefaultTableModel modelSuplier;
private String selectedKode = "";
    ...
    public Suplier() {
        ...
        modelSuplier = new DefaultTableModel(new Object[]{"Kode", "Nama", "Alamat", "No Telp"}, 0) {
            @Override
            public boolean isCellEditable(int row, int col) { return false; }
        };
        tblSuplier.setModel(modelSuplier);
        loadSuplier();
    }
    
    private void loadSuplier() {
        modelSuplier.setRowCount(0);
        ...
        try {
            ...
            while (rs.next()) {
                modelSuplier.addRow(new Object[] {
    ...
    private void initComponents() {
        ...
        lblKodeSuplier = new javax.swing.JLabel();
        ...
        jLabel1.setText("Master Form Suplier");
        ...
        lblKodeSuplier.setText("Kode Suplier");
        ...
        jScrollPane2.setViewportView(txtAlamatSuplier);
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(70, 70, 70)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtKodeSuplier, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblNamaSuplier)
                            .addComponent(txtNamaSuplier, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblAlamatSuplier)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(14, 14, 14)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtKodeSuplier, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(lblNamaSuplier)
                        .addGap(14, 14, 14)
                        .addComponent(txtNamaSuplier, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20)
                        .addComponent(lblAlamatSuplier)
    ...
    if ("".equals(selectedKode)) {
        JOptionPane.showMessageDialog(this, "Pilih Suplier!");
        return;
    }
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        try {
            Connection conn = Koneksi.getConnection();
            String sqlHapus = "DELETE FROM suplier WHERE kode_suplier=?";
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
     if (
             txtKodeSuplier.getText().isEmpty() ||
             txtNamaSuplier.getText().isEmpty() || 
             txtAlamatSuplier.getText().isEmpty() || 
     ...
     try {
         Connection conn = Koneksi.getConnection();
         String sqlTambah = "INSERT INTO suplier (kode_suplier, nama_suplier, alamat, no_telp) VALUES (?, ?, ?, ?)";
         PreparedStatement ps = conn.prepareStatement(sqlTambah);
         ps.setString(1, txtKodeSuplier.getText());
         ps.setString(2, txtNamaSuplier.getText());
         ps.setString(3, txtAlamatSuplier.getText());
    ...
    private void tblSuplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSuplierMouseClicked
     ...
     selectedKode = modelSuplier.getValueAt(row, 0).toString();
     txtKodeSuplier.setText(selectedKode);
     txtNamaSuplier.setText(modelSuplier.getValueAt(row, 1).toString());
     txtAlamatSuplier.setText(modelSuplier.getValueAt(row, 2).toString());
     txtNoTelp.setText(modelSuplier.getValueAt(row, 3).toString());
    ...
    private javax.swing.JLabel lblKodeSuplier;
